...
def main():
    ...
    while refresh:
        ...
        title_font = pygame.font.Font('Charge Vector Black.otf', 64)
        name = title_font.render('Catcher', True, (240, 230, 100))
        win.blit(name, (320, 300))

        welcome_font = pygame.font.Font('Square One Bold.ttf', 120)
        name = welcome_font.render('Welcome', True, (200, 100, 100))
        win.blit(name, (220, 150))

        start = pygame.image.load("start2.png")
        ...
        if logged_in:
            # dispaly information about the logged in user
            ...
            user_topscore = font.render('Top Score : {}'.format(dbf.get_user_top_score(player_id)), True, (240, 230, 100))
        ...
        # login button:
        login_button_font = pygame.font.Font('Charge Vector Black.otf', 32)
        ...
        # highscore button
        highscore_button_font = pygame.font.Font('Charge Vector Black.otf', 28)
